				...
				<div class="container">
					...
					<div class="row">
						<ul class="portfolio-list sort-destination" data-sort-id="portfolio" data-plugin-options='{"delegate": "a", "type": "image", "gallery": {"enabled": true}}'>
							<li class="col-md-3 isotope-item exame-faixa">
								<div class="portfolio-item img-thumbnail">
									<a href="album-exame-faixa-2014.php" class="thumb-info">
										<img alt="" class="img-responsive" src="https://lh3.googleusercontent.com/-QJ9br_5-wFI/U8XH-qk7GpI/AAAAAAAAEw0/n6OteRj3cYI/w1545-h822-no/DSC_0140-2.jpg">
										<span class="thumb-info-title">
											<span class="thumb-info-inner">Exame de faixa 2014</span>
											<span class="thumb-info-type">Içara - SC</span>
										</span>
								...
								<div class="portfolio-item img-thumbnail">
									<a href="album-koshukai-criciuma-tubarao.php" class="thumb-info">
										...
										<span class="thumb-info-title">
											...
											<span class="thumb-info-type">Criciuma / Tubarão - SC</span>
										</span>
										<span class="thumb-info-action">
											<span title="Universal" class="thumb-info-action-icon"><i class="icon icon-picture-o"></i></span>
										</span>
							...
							<li class="col-md-3 isotope-item exame-faixa">
								<div class="portfolio-item img-thumbnail">
									<a href="album-exame-faixa-2013.php" class="thumb-info">
										<img alt="" class="img-responsive" src="https://lh6.googleusercontent.com/-tDY0LtYWBcw/Uq7Ymfp5lFI/AAAAAAAAEE4/x1JkFNyV8eU/w1024-h678-no/DSC_0153.jpg">
										<span class="thumb-info-title">
							...
							<li class="col-md-3 isotope-item exame-faixa">
								<div class="portfolio-item img-thumbnail">
									<a href="album-50-anos-aikido.php" class="thumb-info">
										<img alt="" class="img-responsive" src="https://lh6.googleusercontent.com/-HcUbaYvNTPI/UjJygj3XKfI/AAAAAAAAD4E/r3kKnBeLpnU/w1306-h865-no/DSC_0273.jpg">
										<span class="thumb-info-title">
											<span class="thumb-info-inner">50 Anos de aikido no brasil</span>
							...
							<li class="col-md-3 isotope-item exame-faixa">
								<div class="portfolio-item img-thumbnail">
									<a href="album-exame-jaguaruna-2013.php" class="thumb-info">
										<img alt="" class="img-responsive" src="https://lh3.googleusercontent.com/-qyJgKVq1t5s/Udv_Dr0xo2I/AAAAAAAADBI/ZMB9m__r_SA/w1306-h865-no/DSC_0097.jpg">
										<span class="thumb-info-title">
											<span class="thumb-info-inner">Exame de faixa 2013</span>
